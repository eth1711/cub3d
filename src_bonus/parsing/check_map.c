...
/*   Updated: 2024/12/10 22:13:09 by amaligno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d_bonus.h"

static int	count_spaces(char **map, t_vectori *start)
{
	int	x;
	int	y;
	int	spaces;
...
static void	check_char(char **map, char c, t_vectori pos, int *count)
{
	if (c && !ft_strchr("1F ", c))
	{
		map[pos.y][pos.x] = 'F';
